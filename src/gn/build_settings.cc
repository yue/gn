...
bool BuildSettings::IsChromiumPath(const std::string& path) const {
  return use_chromium_config() &&
      (path.starts_with("//build/") ||
       path.starts_with("//buildtools/") ||
       path.starts_with("//testing/") ||
       path.starts_with("//tools/") ||
       path.starts_with("//third_party/catapult/") ||
       path.starts_with("//third_party/googletest/") ||
       path.starts_with("//third_party/libc++/") ||
       path.starts_with("//third_party/libc++abi/") ||
       path.starts_with("//third_party/libunwind/") ||
       path.starts_with("//third_party/llvm-build/") ||
       path.starts_with("//third_party/llvm-libc/"));
}
